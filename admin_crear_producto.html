...
<head>
    ...
    <style>
        * {
        ...
        .grupo-input input, .grupo-input-completo input, .grupo-input-completo textarea {
            width: 100%;
            padding: 12px;
                ...
                <div class="contenedor-formulario">
                    ...
                    <form action="admin_productos.html">
                        ...
                        <div class="grupo-input-completo">
                            ...
                            <input type="text" placeholder="Ej. Monitor UltraWide 34&quot;" required>
                        </div>

                        <div class="grupo-input-completo">
                            <label>DESCRIPCIÓN</label>
                            <textarea rows="4" placeholder="Ingrese las especificaciones técnicas" required></textarea>
                        </div>
                        ...
                        <div class="acciones-formulario">
                            ...
                            <a href="admin_productos.html" class="btn-texto">CANCELAR</a>
                        </div>
